<%@ Page Title="" Language="C#" MasterPageFile="../MasterProfil.Master" EnableViewState="true" AutoEventWireup="true" CodeBehind="profilim.aspx.cs" Inherits="bootstrapWeb.siteAdmin.profilim" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    ...
    <div class="btn-group ">
        <asp:Button ID="btn_filmBilgi" CssClass="btn btn-info" runat="server" Text="Film Bilgi" OnClick="btn_filmBilgi_Click"/>
        <asp:Button ID="btn_altyaziBilgi" CssClass="btn btn-info" runat="server" Text="Altyazı Bilgi" OnClick="btn_altyaziBilgi_Click" />
        <asp:Button ID="btn_kullaniciBilgi" CssClass="btn btn-info" runat="server" Text="Kullanıcı Bilgi" OnClick="btn_kullaniciBilgi_Click" />
        <asp:Button ID="btn_filmEkle" CssClass="btn btn-info" runat="server" Text="Film Ekle" OnClick="btn_filmEkle_Click"/>
    ...
    <div id="div_film" runat="server" visible="false" class="scroll">
        <h4 class="dropdown-header"><asp:Label runat="server" ID="lbl_filmBilgi"></asp:Label></h4>
        <!-- Film Listesi güncelleme tablosu -->
        <h2><asp:Label runat="server" Text="Film Bilgileri" ></asp:Label></h2>
        <asp:GridView ID="grid_Films" runat="server" AutoGenerateColumns="false"
            CssClass="table table-responsive table-hover table-bordered"
            OnPageIndexChanging="grid_Films_PageIndexChanging"
            OnRowCancelingEdit="grid_Films_RowCancelingEdit" 
            OnRowDeleting="grid_Films_RowDeleting" 
            OnRowEditing="grid_Films_RowEditing" 
            OnRowUpdating="grid_Films_RowUpdating"
            EditRowStyle-CssClass="table table-responsive alert-info"
            PageSize="10"
            AllowPaging="true">
    <Columns>
        <asp:BoundField DataField="FilmsID" HeaderText="Film No" ReadOnly="true" />
        <asp:BoundField DataField="Name" HeaderText="Film Adı" />
    ...
    <!-- Altyazı Bilgileri Güncelleme tablosu -->
    <div id="div_altyazi" runat="server" visible="false" class="scroll">
        ...
        <asp:GridView ID="grid_altyazi" runat="server" AutoGenerateColumns="false"
            ...
            EditRowStyle-CssClass="table table-responsive table-bordered alert-info alert"
            PageSize="10"
            AllowPaging="true">
    <Columns>
    ...
    <!-- Genel kullanıcı listesi düzenleme tablosu -->
    <div id="div_kullanicilar" runat="server" visible="false" class="scroll">
        <h4 class="dropdown-header"><asp:Label runat="server" ID="lbl_kullaniciBilgi"></asp:Label></h4>
        <h2><asp:Label runat="server" Text="Kullanıcıların Bilgileri"></asp:Label></h2>
        <asp:GridView ID="grid_kullanicilar" runat="server" AutoGenerateColumns="false"
            CssClass="table table-responsive table-hover table-bordered"
            OnPageIndexChanging="grid_kullanicilar_PageIndexChanging"
            OnRowCancelingEdit="grid_kullanicilar_RowCancelingEdit"
            OnRowDeleting="grid_kullanicilar_RowDeleting"
            OnRowEditing="grid_kullanicilar_RowEditing"
            OnRowUpdating="grid_kullanicilar_RowUpdating"
            EditRowStyle-CssClass="table table-responsive table-bordered alert-info alert"
            AllowPaging="true">
    <Columns>
        <asp:BoundField DataField="UsersID" HeaderText="Kullanıcı No" ReadOnly="true" />
        <asp:BoundField DataField="Name" HeaderText="Kullanıcı Adı" />
        <asp:BoundField DataField="EMail" HeaderText="E-Posta" />
        <asp:BoundField DataField="Password" HeaderText="Şifresi :)" />
        <asp:BoundField DataField="Roles" HeaderText="Rolleri !" />
        <asp:CommandField ShowEditButton="true" ButtonType="Button" ControlStyle-CssClass="btn btn-primary btn-block" />
        <asp:CommandField ShowDeleteButton="true" ButtonType="Button" ControlStyle-CssClass="btn btn-primary btn-block" />
        </Columns>
        </asp:GridView>
